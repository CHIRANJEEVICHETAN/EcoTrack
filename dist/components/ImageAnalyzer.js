...
export default function ImageAnalyzer({ onAnalysisComplete }) {
    ...
    const onDrop = useCallback((acceptedFiles) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const analysis = yield handleImageUploadAndAnalyze(file);
    ...
    return (React.createElement("div", { className: "mt-4" },
        React.createElement("div", Object.assign({}, getRootProps(), { className: `border-2 border-dashed rounded-lg p-6 text-center cursor-pointer
          ${isDragActive ? 'border-green-500 bg-green-50' : 'border-gray-300 hover:border-green-500'}
        ` }),
            React.createElement("input", Object.assign({}, getInputProps())),
            analyzing ? (React.createElement("div", { className: "text-gray-600" },
                React.createElement("svg", { className: "animate-spin h-6 w-6 mx-auto mb-2", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24" },
                    React.createElement("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }),
                    React.createElement("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })),
                "Analyzing image...")) : (React.createElement("div", null,
                ...
                React.createElement("p", { className: "mt-1" }, "Drag and drop an image here, or click to select"),
                React.createElement("p", { className: "text-sm text-gray-500" }, "PNG, JPG, JPEG up to 10MB")))),

...
export function analyzeWasteImage(file_1) {
    return __awaiter(this, arguments, void 0, function* (file, retries = 3) {
        try {
            const model = genAI.getGenerativeModel({ model: 'gemini-1.5-flash' });
            // Prepare the image data
            const imagePart = yield fileToGenerativePart(file);
...
export const handleImageUploadAndAnalyze = (file) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const analysisResult = yield analyzeWasteImage(file);
...
export function getRecyclingRecommendations(itemType, condition, description) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
